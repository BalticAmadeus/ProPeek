...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "vsc-profiler" is now active in the web extension host!');
	...
	let disposable = vscode.commands.registerCommand('vsc-profiler.helloWorld', () => {
		...
		profilerParser.parse('test.prof'); //TODO get file name from user
